...
ln2, = ax.plot(track_log_5, label='CEGE', marker='o', markersize=6, markevery=100)
ln1, = ax.plot(track_log_3, label='DGD', marker='s', markersize=6, markevery=80)
ln4, = ax.plot(track_log_6, label='EXTRA', marker='v', markersize=6, markevery=80)
ln3, = ax.plot(track_log_4, label='CEGE-SARAH', marker='o', markersize=8, markevery=80)

plt.legend(handles=[ln1, ln4, ln2,   ln3], loc='upper right')
plt.show()
